...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        regressor = log_function_run(Regressor, features_file="./out/orthomam_features_with900extra_020325.parquet", test_size=0.2,
                                     mode=3,
                                     predicted_measure='msa_distance', i=i, remove_correlated_features=False)
        mse = log_function_run(regressor.random_forest, i=i, n_estimators=150, criterion = "squared_error", bootstrap=False, verbose=1)
        # mse = log_function_run(regressor.deep_learning, i=i, epochs=50, batch_size=64, learning_rate=0.0001, dropout_rate=0.2, l1=0.00001, l2=0.00001, repeats=1, mixed_portion=0.3, top_k=4, mse_weight=0, ranking_weight=50)
