...
def get_prostt5_embedding(sequence: str) -> np.ndarray:
    ...
    return embedding.mean(dim=0).numpy() # I can test other aggregations, such as max, min, etc.

# embedding = get_prostt5_embedding("MSEQNNTEMTFQIQRIYTKDISFEAPNAPHVFQKDWMAQ")
# print(embedding.shape)  # e.g. (1024,)
