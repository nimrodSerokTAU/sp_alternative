...
if __name__ == '__main__':
    X_test, test_df, true_score_name, main_codes_test, file_codes_test = use_test_from_origin(
        features_file='/Users/kpolonsky/Documents/sp_alternative/feature_extraction/out/balibase_RV10-50_features_251224.csv',
        predictions_file='/Users/kpolonsky/Documents/sp_alternative/feature_extraction/out/BaliBase_ALL_10-50/DL6_w_new_features_with_SoP/prediction_DL_0_mode1_msa_distance.csv')
    scaler = joblib.load(
        f'/Users/kpolonsky/Documents/sp_alternative/feature_extraction/out/BaliBase_ALL_10-50/DL6_w_new_features_with_SoP/scaler_0_mode1_msa_distance.pkl')
    ...
    model = load_model(
        f'/Users/kpolonsky/Documents/sp_alternative/feature_extraction/out/BaliBase_ALL_10-50/DL6_w_new_features_with_SoP/regressor_model_0_mode1_msa_distance.keras')
    X_test_subset = X_test_scaled_with_names.sample(n=1000, random_state=42)
