...
if __name__ == '__main__':
    X_test, test_df, true_score_name, main_codes_test, file_codes_test = use_test_from_origin(
        ...
        predictions_file='/Users/kpolonsky/Documents/sp_alternative/feature_extraction/out/orthomam_all_w_balify_no_ancestors/DL1/prediction_DL_0_mode2_msa_distance.csv')
    scaler = joblib.load(
    ...
    # shap.initjs()
    matplotlib.use('Agg')
    shap_values = joblib.load('/Users/kpolonsky/Documents/sp_alternative/feature_extraction/out/orthomam_all_w_balify_no_ancestors/DL1/shap_values.pkl')
