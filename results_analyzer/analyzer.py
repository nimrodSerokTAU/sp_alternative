...
pl1.double_col_plot([fig1_emp.get_example_scatter(), fig1_emp.get_r_scatter(), fig1_sim.get_example_scatter(),
                     fig1_sim.get_r_scatter()],
                    ['a', 'c', 'b', 'd'], {})
...
pl2.double_col_plot([fig2_emp.get_example_scatter(), fig2_emp.get_r_scatter(), fig2_sim.get_example_scatter(),
                     fig2_sim.get_r_scatter()],
                    ['a', 'c', 'b', 'd'],
...
pl_s_3.double_col_plot(
    [fig_s3a_emp.get_example_scatter(), fig_s3a_emp.get_r_scatter(), fig_s3b_sim.get_example_scatter(),
     fig_s3b_sim.get_r_scatter()],
    ['a', 'c', 'b', 'd'], {})

# fig s 4:
fig_s_4_1k = CorrelationAnalyzer(data_dir,
...
fig_s_4_5k = CorrelationAnalyzer(data_dir,
...
pl_s_4 = PlotLayout(14, 6, 1, 2, output_path, 'FigS4')
pl_s_4.double_col_plot([fig_s_4_1k.get_example_rank_scatter(), fig_s_4_5k.get_example_rank_scatter()],
                       ['a', 'b'],
                       {})

# fig S 5"
fig_s_5 = StackedColGraph(data_dir,
                          [{'relative_file_path': 'input/OrthoMaM/subsampling/subsampling_summary.csv',
                            'series_name': 'Samples'}],
                          [Measure(key='20', external_name='', presentation_name='20 Samples', correlation_direction=0),
                           ...
                           Measure(key='100', external_name='', presentation_name='100 Samples',
                                   correlation_direction=0),
                           Measure(key='200', external_name='', presentation_name='200 Samples',
                                   correlation_direction=0),
                           Measure(key='400', external_name='', presentation_name='400 Samples',
                                   correlation_direction=0),
                           Measure(key='800', external_name='', presentation_name='800 Samples',
                                   correlation_direction=0),
                           Measure(key='1600', external_name='', presentation_name='1600 Samples',
                                   correlation_direction=0)],
                          [Measure(key='sop', external_name='SoP', presentation_name='SoP', correlation_direction=0),
                           Measure(key='model2', external_name='Predicted', presentation_name='Model2',
                                   correlation_direction=0),
...
pl_s_5 = PlotLayout(12, 6, 1, 1, output_path, 'FigS5')
pl_s_5.single_col_plot([fig_s_5.subplot], [''], ['Test'])
...
pl_s_4 = PlotLayout(12, 6, 1, 1, output_path, 'FigS4')
pl_s_4.single_col_plot([fig_s_4.create_col_graph()], [''], ['Test'])

# fig 8 a, b  #
fig_s_8_nuc = CorrelationAnalyzer(data_dir,
                                  ...
                                  '40_S29', False, 'Correlation with Distance from True', 401, 1)

pl_s_8 = PlotLayout(14, 6, 1, 2, output_path, 'FigS8')
pl_s_8.double_col_plot([fig_s_8_nuc.get_example_scatter(), fig_s_8_nuc.get_r_scatter()],
                       ['a', 'b'], {})
