...
empirical_example: str = 'BBS30006'  # 'BBA0058'
...
#                               ['input/BAliBASE/balibase_features_w_aligner_090426.csv'],
#                               'dseq_from_true',
...
fig3a = PDFAnalyzer(data_dir=data_dir,
                    features_file_name='input/BAliBASE/balibase_features_w_aligner_090426.csv',
...
#                        [{'relative_file_path': 'input/empirical/pick_me_trio_overall_v0_20251116.csv',
#                          'series_name': 'Empirical'},
#                         {'relative_file_path': 'input/simulated/pick_me_trio_overall_v0_20251116.csv',
