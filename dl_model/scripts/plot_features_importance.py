...
if __name__ == '__main__':
    X_test, test_df, true_score_name, main_codes_test, file_codes_test = use_test_from_origin(
        features_file='/dl_model/out/orthomam_features_251224.csv',
        predictions_file='/dl_model/out/orthomam_all_w_balify_no_ancestors/DL14_L1L2_bs32/prediction_DL_0_mode1_msa_distance.csv')
    scaler = joblib.load(
        f'/dl_model/out/orthomam_all_w_balify_no_ancestors/DL14_L1L2_bs32/scaler_0_mode1_msa_distance.pkl')
    ...
    model = load_model(
        f'/Users/kpolonsky/Documents/sp_alternative/dl_model/out/orthomam_all_w_balify_no_ancestors/DL14_L1L2_bs32/regressor_model_0_mode1_msa_distance.keras')
    ...
    # shap.initjs()
    matplotlib.use('Agg')
    # shap_values = joblib.load(f'/Users/kpolonsky/Documents/sp_alternative/dl_model/out/orthomam_all_w_balify_no_ancestors/Orthomam_mode4/DL_w_weights/shap_values__0_mode4_msa_distance.pkl')
    ...
    plt.savefig('/Users/kpolonsky/Documents/sp_alternative/dl_model/out/waterfall_0_plot.png', dpi=300, bbox_inches='tight')
    # plt.show()
    plt.close()
    ...
    #     plt.savefig(f'/Users/kpolonsky/Documents/sp_alternative/dl_model/out/waterfall_{i}_plot.png', dpi=300, bbox_inches='tight')
    #     # plt.show()
    #     plt.close()
