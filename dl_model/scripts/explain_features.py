...
if __name__ == '__main__':
    ...
    for i in range(n):
        X_test, test_df, true_score_name, main_codes_test, file_codes_test = use_test_from_origin(features_file=
                                                                                                  "/dl_model/out/balibase_RV10-50_features_080125_w_foldmason_scores.csv", predictions_file=f'/dl_model/out/BaliBase_ALL_10-50/DL8_w_foldmason_features/prediction_DL_{i}_mode1_msa_distance.csv', mode=1, portion=0.1)

        scaler = joblib.load(
            f'/dl_model/out/BaliBase_ALL_10-50/DL8_w_foldmason_features/scaler_{i}_mode1_msa_distance.pkl')
        ...
        model = load_model(
            f'/Users/kpolonsky/Documents/sp_alternative/dl_model/out/BaliBase_ALL_10-50/DL8_w_foldmason_features/regressor_model_{i}_mode1_msa_distance.keras')
